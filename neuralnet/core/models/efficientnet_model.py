...
class EfficientNet(nn.Module):
  ...
  def from_name(cls, model_name, override_params=None, norm_layer=None, condconv_num_expert=1):
    ...
    blocks_args, global_params = get_model_params(
      model_name, override_params, condconv_num_expert=condconv_num_expert)
...
def create_efficientnet_model(params, num_classes, is_training):
   model = EfficientNet.from_name(params.model)
